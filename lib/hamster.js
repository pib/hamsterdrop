...
function Hamster() {
    ...
    this.setFrames(this.getSheetFrames('hamster', 'stand'));
}
gamejs.utils.objects.extend(Hamster, AnimatedSprite);

Hamster.prototype.stand = function() {
    this.setFrames(this.getSheetFrames('hamster', 'stand'));
};
Hamster.prototype.right = function() {
    this.setFrames(this.getSheetFrames('hamster', 'right'));
};
Hamster.prototype.left = function() {
    this.setFrames(this.getSheetFrames('hamster', 'left'));
};
